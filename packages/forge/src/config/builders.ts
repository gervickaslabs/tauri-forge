...
import { CommandAdapterFactory } from "@tauriforge/forge/adapters";
import { EventAdapterFactory } from "@tauriforge/forge/adapters";
...
export function buildAdapterConfig<T extends { enabled: boolean }, C = unknown>(
  defaultConfig: T,
  customConfig: C,
): T {
